...
namespace Helpers
{
    ...
    void SetModifierKeyEvents(const Shortcut& shortcutToBeSent, const ModifierKey& modifierKeyInvoked, LPINPUT keyEventArray, int& index, bool isKeyDown, ULONG_PTR extraInfoFlag, const Shortcut& shortcutToCompare, const DWORD& keyToBeReleased)
    {
        ...
        if (isKeyDown)
        {
            ...
            {
                Logger::trace(L"{} @ {} {} {} {}", __FUNCTIONW__, __LINE__, shortcutToBeSent.GetCtrlKey(modifierKeyInvoked) != NULL, (shortcutToCompare.IsEmpty() || shortcutToBeSent.GetCtrlKey(modifierKeyInvoked) != shortcutToCompare.GetCtrlKey(modifierKeyInvoked)), (keyToBeReleased == NULL || !shortcutToBeSent.CheckCtrlKey(keyToBeReleased)));
            ...
            {
                Logger::trace(L"{} @ {} {} {}", __FUNCTIONW__, __LINE__, shortcutToBeSent.GetAltKey(modifierKeyInvoked), shortcutToBeSent.GetCtrlKey(modifierKeyInvoked) != NULL);
        ...
        else
        {
            ...
            {
                Logger::trace(L"{} @ {} -- {} -- {}", __FUNCTIONW__, __LINE__, static_cast<WORD>(shortcutToBeSent.GetCtrlKey(modifierKeyInvoked)), shortcutToBeSent.GetCtrlKey(modifierKeyInvoked));
